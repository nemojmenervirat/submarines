...
public class SubmarineFactory {
	...
	public static Submarine createNew(Type type, Direction direction, float x, float y) {
		...
		submarine.getProjectile().setImagePath(getPath("img/projectile1", direction));
		submarine.setTotalAttacks(1);
		submarine.setTotalSonarTurns(3);

		switch (type) {
		case T1:
			submarine.setImagePath(getPath("img/submarine1", direction));
			...
			break;
		case T2:
			submarine.setImagePath(getPath("img/submarine2", direction));
			...
			break;
		case T3:
			submarine.setImagePath(getPath("img/submarine3", direction));
			...
			break;
		case T4:
			submarine.setImagePath(getPath("img/submarine4", direction));
			...
			break;
		case T5:
			submarine.setImagePath(getPath("img/submarine5", direction));
